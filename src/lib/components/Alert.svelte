<script lang="ts">
	...
	const alertStyles = {
		info: 'text-blue-800 bg-blue-100 dark:bg-gray-700 dark:text-blue-400',
		success: 'text-green-800 bg-green-100 dark:bg-gray-700 dark:text-green-400',
		warning: 'text-yellow-800 bg-yellow-100 dark:bg-gray-700 dark:text-yellow-300',
		error: 'text-red-800 bg-red-100 dark:bg-gray-700 dark:text-red-400',
		dark: 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300'
	};
	...
	<div class={`my-4  items-center rounded-lg p-4 ${alertStyles[type]} ${classname}`} role="alert">
		<div class="flex">
			...
			{#if dismissible}
				<button
					type="button"
					class="-mx-1.5 -my-1.5 ms-auto inline-flex h-6 w-6 items-center justify-center rounded-full bg-white p-1.5 text-gray-400 hover:bg-gray-100 focus:ring-2 focus:ring-gray-300 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-600"
					aria-label="Close"
					onclick={closeAlert}
				>
