...
<div
	class="aspect-w-2 aspect-h-3 relative mx-auto w-full max-w-[300px] rounded-[2.5rem] border-[14px] border-gray-800 bg-gray-800 dark:border-gray-800 
...
>
	...
	></div>
	<div class="h-full w-full overflow-hidden rounded-[2rem] bg-gray-800">
