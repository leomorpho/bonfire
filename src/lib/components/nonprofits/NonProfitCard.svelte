...
<Card.Root
	class={`non-profit-card ${cls} ${selectable ? 'cursor-pointer' : ''} relative m-3 max-w-sm overflow-hidden rounded-xl border border-gray-200 bg-slate-200 shadow-sm transition-all duration-200 hover:shadow-lg dark:border-gray-700 dark:bg-slate-800 
