...
<footer
	class="footer bg-white p-10 text-slate-400 dark:bg-slate-900 dark:text-slate-200 sm:flex sm:justify-around"
>
	...
	<nav>
		...
		<a class="link link-hover" href={`mailto:${publicEnv.PUBLIC_FROM_EMAIL}`}>Contact</a>
	</nav>
	<!-- <div>
