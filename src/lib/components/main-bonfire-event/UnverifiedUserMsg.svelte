		...
		<div class="mt-4 flex w-full justify-center">
			<div class="flex flex-col space-y-2 sm:flex-row sm:space-x-2 sm:space-y-0">
				<Button
					...
					class="flex items-center justify-center bg-blue-500 text-white hover:bg-blue-400"
				>
					<Copy class="h-5 w-5" />
					Copy Link</Button
				><a href="/login" class="w-full">
					<Button
						class="flex items-center justify-center dark:bg-slate-900 dark:text-white dark:hover:bg-slate-800 "
					>
